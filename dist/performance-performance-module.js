    ...
    FormLibraryComponent.prototype.openModal = function (type, url) {
        ...
        this.dialogRef.afterClosed().subscribe(function (response) {
            if (!response) {
                ...
                _this.apiService.postData(url, response).subscribe(function (res) {
    ...
    FormLibraryComponent.prototype.editpopup = function (type, row, url) {
        ...
        this.dialogRef.afterClosed().subscribe(function (response) {
            if (!response) {
                ...
                var id = response.id;
                delete response.id;
                _this.apiService.postData(url + '/' + id, response).subscribe(function (res) {
                    if (res.status == 'success') {
                        _this.apiloader.setLoader(false);
                        if (type == 'goal') {
                            _this.getGoals();
...
var PerformanceEvaluationComponent = /** @class */ (function () {
    ...
    PerformanceEvaluationComponent.prototype.onClick = function () {
        this.searstr = this.query;
    };
    PerformanceEvaluationComponent.prototype.onClickName = function () {
        var _this = this;
        var data1 = this.dataSource;
        this.dataSource = [];
        this.order = !this.order;
        data1.sort(function (n1, n2) {
            return (_this.order) ? n1.performance_name.localeCompare(n2.performance_name) : n2.performance_name.localeCompare(n1.performance_name);
        });
...
var PerformanceManagementComponent = /** @class */ (function () {
    ...
    PerformanceManagementComponent.prototype.onClick = function () {
        this.searstr = this.query;
    };
...
var PerformanceSettingComponent = /** @class */ (function () {
    function PerformanceSettingComponent(router, toast, apiService, apiloader) {
        var _this = this;
        this.router = router;
        this.toast = toast;
        this.apiService = apiService;
    ...
    PerformanceSettingComponent.prototype.onSubmit = function () {
        ...
        this.apiService.postData('appraisal-cycle/assign', { client_id: id, goal_setting_form_id: this.enrollmentForm, users: users }).subscribe(function (response) {
            if (response.data) {
                ...
                console.log(data);
                _this.dataSource = data;
                _this.router.navigate(['/apps/performance/performance-evaluation']);
    ...
    PerformanceSettingComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_8__["Router"], _fuse_services_toaster_service_service__WEBPACK_IMPORTED_MODULE_7__["ToasterService"], _fuse_services_api_service__WEBPACK_IMPORTED_MODULE_6__["ApiService"], _fuse_services_api_loader_service__WEBPACK_IMPORTED_MODULE_5__["ApiLoaderService"]])
