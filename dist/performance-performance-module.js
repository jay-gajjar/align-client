...
var FormLibraryComponent = /** @class */ (function () {
    function FormLibraryComponent(fb, apiService, dialog, apiloader, route, router) {
        var _this = this;
        this.fb = fb;
        this.apiService = apiService;
        this.dialog = dialog;
    ...
    FormLibraryComponent.prototype.deleteItem = function (type, id, url) {
        ...
        this.apiService.deleteData(url + '/' + id).subscribe(response => {
          if (response.status == 'success') {
            ...
            if (type == 'goal') { this.getGoals(); }
            else if(type == 'cvalue') { this.getCorVals();}
            else { this.getSkills(); }
          }
    ...
    FormLibraryComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"], _fuse_services_api_service__WEBPACK_IMPORTED_MODULE_4__["ApiService"], _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatDialog"],
...
var EditEvaluationComponent = /** @class */ (function () {
    function EditEvaluationComponent(_formBuilder, apiService, dialog, apiloader, route, router) {
        var _this = this;
    ...
    EditEvaluationComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"], _fuse_services_api_service__WEBPACK_IMPORTED_MODULE_6__["ApiService"], _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialog"],
...
var EvaluationPopComponent = /** @class */ (function () {
        ...
        if (data.modalType == "goal") {
            ...
            if (data.details) {
                ...
                this.editForm.patchValue({ category: formData.category, name: formData.name, description: formData.description,
                    measurement: formData.measurement, weightage: formData.weightage, user_comments: formData.review.user_comments,
    ...
    EvaluationPopComponent.prototype.response = function (data) {
        if (this.id) {
            data.id = this.id;
        }
        this.dialogRef.close(data);
...
var PerformanceManagementComponent = /** @class */ (function () {
    function PerformanceManagementComponent(router, apiService, apiloader) {
        this.router = router;
        this.apiService = apiService;
        this.apiloader = apiloader;
    ...
    PerformanceManagementComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"], _fuse_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"], _fuse_services_api_loader_service__WEBPACK_IMPORTED_MODULE_2__["ApiLoaderService"]])
...
var PerformanceSettingComponent = /** @class */ (function () {
    function PerformanceSettingComponent(apiService, apiloader) {
        var _this = this;
        this.apiService = apiService;
        this.apiloader = apiloader;
        this.visible = true;
    ...
    PerformanceSettingComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_fuse_services_api_service__WEBPACK_IMPORTED_MODULE_6__["ApiService"], _fuse_services_api_loader_service__WEBPACK_IMPORTED_MODULE_5__["ApiLoaderService"]])
